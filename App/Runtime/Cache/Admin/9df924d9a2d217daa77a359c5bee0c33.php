...
<<<<<<< HEAD
    ...
    <script src="/legacy/Public/bootstrap/js/jquery-3.4.1.js"></script>
...
<<<<<<< HEAD
                    <li class="active"><a href="/legacy/Admin/Index/index"><span class="glyphicon glyphicon-home" aria-hidden="true"></span> 首页</a></li>
                    <li class="dropdown">
                        <a href="/legacy/Admin/Guest/index" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-star" aria-hidden="true"></span> 顾客管理<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="/legacy/Admin/Guest/index">查看顾客信息</a></li>
                            <li><a href="/legacy/Admin/Guest/searchguest">查询顾客</a></li>
                        </ul>
                    </li>
                    <li class="dropdown">
                        <a href="/legacy/Admin/Goods/index" class="dropdown-toggle" data-toggle="dropdown"><span class="glyphicon glyphicon-shopping-cart" aria-hidden="true"></span> 商品管理<b class="caret"></b></a>
                        <ul class="dropdown-menu">
                            <li><a href="/legacy/Admin/Goods/index">查看商品</a></li>
                            <li><a href="/legacy/Admin/Goods/add">添加商品</a></li>
                            <li><a href="/legacy/Admin/Goods/index">删除商品</a></li>
                            <li><a href="/legacy/Admin/Goods/index">修改商品</a></li>
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a href="/legacy/Admin/Travel/index">查看旅游景点</a></li>
                            <li><a href="/legacy/Admin/Travel/add">增加旅游景点</a></li>
                            <li><a href="/legacy/Admin/Travel/search">查询旅游景点</a></li>
                            <li><a href="/legacy/Admin/Travel/index">修改旅游景点</a></li>
=======
...
<<<<<<< HEAD
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="/legacy/Admin/Notice/revise">修改公告</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="/legacy/Admin/Dynamic/revise">修改动态</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="/legacy/Admin/Inheritor/delete">删除传承人</a></li>
                                    <li><a href="/legacy/Admin/Inheritor/revise">修改传承人</a></li>
                                </ul>
                            </li>
                            <li class="dropdown-submenu">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="/legacy/Admin/Policy/delete">删除政策</a></li>
                                    <li><a href="/legacy/Admin/Policy/revise">修改政策</a></li>
=======
