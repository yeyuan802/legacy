...
<body>
        <div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
            <ul class="list-group">
                ...
                <a href="/EPP_Project/legacy/Admin/Dynamic/revise" class="list-group-item active">修改动态</a>
            </ul>
        </div>
        <!--右侧主要内容-->
                    ...
                    <div class="panel panel-default">
                        <div class="panel-body">
                            <ul id="myTab" class="nav nav-tabs" role="tablist">
                                <li class="active">
                                    <a href="#bulletin" role="tab" data-toggle="tab">修改动态</a>
                                </li>
                            </ul>
                            <!--选项卡面板-->
                            <div id="myTabContent" class="tab-content">
                                <div class="tab-pane active" id="bulletin">
                                    ...
                                    <table class="table table-hover">
                                        <tr><th width="80">动态id：</th><td><input type="text" name="id"></td></tr>
                                        <tr><th>动态题目：</th><td><input type="text" name="title"></td></tr>
                                        <tr><th>动态内容：</th><td><textarea name="content"></textarea></td></tr>
