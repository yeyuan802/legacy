...
<script>
    ...
    $(document).ready(function () {
        $(".activemenu li ul li a").each(function () {
            $this=$(this);
            if($this[0].href==String(window.location)){
                $this.parent().addClass("active");
            }
...
<div class="col-xs-12 col-sm-2 col-md-2 col-lg-2">
    <ul class="list-group">
        ...
        <a href="/EPP_Project/legacy/Admin/Goods/search" class="list-group-item active">查询商品</a>
    </ul>
</div>
<!--右侧主要内容-->
<div class="col-xs-12 col-sm-10 col-md-10 col-lg-10">
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <form class="form-inline" role="form" method="get" action="/EPP_Project/legacy/Admin/Goods/search_ok">
