...
<head>
    ...
    <title>后台登录</title>
    <link href="/legacy/Public/Admin/css/admin.css" rel="stylesheet" />
    <script src="/legacy/Public/Admin/js/jquery-3.4.1.js"></script>
</head>
<body class="login">
<div class="login_box">
    <form method="post">
        ...
        <table>
            ...
            <tr><td>&nbsp;</td><td><img src="/legacy/Admin/Login/getVerify" onclick="this.src='/legacy/Admin/Login/getVerify/'+Math.random()"/></td></tr>
