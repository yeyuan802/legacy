...
<link href="/test/legacy/Public/Home/css/log_reg.css" rel="stylesheet" />
<link href="/test/legacy/Public/bootstrap/css/bootstrap.css" rel="stylesheet" />
	<script type="text/javascript" src="/test/legacy/Public/bootstrap/js/bootstrap.min.js"></script>
<script src="/test/legacy/Public/bootstrap/js/jquery.min.js"></script>
</head>
<body>
	<div class="container">
		<div class="row">
			<div id="login_box">
				...
				<div class="login_main">
					<form class="form-inline" action="/test/legacy/User/login.html" method="post">
						...
						<div class="control-group">
							...
							<div class="controls">
								&nbsp;&nbsp;&nbsp;&nbsp;<img src="/test/legacy/Home/User/captcha" onclick="this.src='/test/legacy/Home/User/captcha/'+Math.random()"/>
							</div>
