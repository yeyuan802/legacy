...
<head>
    ...
    <meta charset="UTF-8">
<title>非遗名录</title>
<link href="/EPP_Project/legacy/Public/Home/css/director.css" rel="stylesheet">
<div class="container" id="directorBox">
    <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6" id="dir-left">
            <!--<a href="<?php echo U('Terrace/ckpt?id='.$msg['glid']);?>" style="color:#4F94CD"><?php echo ($msg['glid']); ?></a></p>-->
            <a href="<?php echo U('Resource/directorList?type='.'民间文学');?>">
                <div class="dir-type1">
