                    ...
                    <div id="minglu-main">
                        <div id = "minglu-main1" class="minglu">
                            <div class="minglu-pic">
                                <img width="90%" height="90%" src="/test/culture3.0/Public/Home/image/icon/shuji.png">
                            </div>
                            ...
                            <div class="minglu-pic">
                                <img width="90%" height="90%" src="/test/culture3.0/Public/Home/image/icon/erhu.png">
                            </div>
                            <div class="minglu-intro">
                                <div class="minglu-list">
                                    <b>民间音乐类</b>
                        ...
                        <div id = "minglu-main2" class="minglu">
                            <div class="minglu-pic">
                                <img width="90%" height="90%" src="/test/culture3.0/Public/Home/image/icon/wudao.png">
                            </div>
                            <div class="minglu-intro">
                                <div class="minglu-list">
                                    <b>民俗舞蹈类</b>
                            ...
                            <div class="minglu-pic">
                                <img width="90%" height="90%" src="/test/culture3.0/Public/Home/image/icon/shanzi.png">
                            </div>
                            <div class="minglu-intro">
                                <div class="minglu-list">
                                    <b>传统工艺类</b>
        ...
        <div class="col-xs-12 col-sm-12 col-md-12  col-lg-8" id="center3-1">
            ...
            <div id="inheritor">
                ...
                <div id="inheritor-pic">
                    <div id="pic" style='background-image: url("/test/culture3.0/Public/Home/image/inheritor/<?php echo ($inher["id"]); ?>.png");'>
                        <div id="pic-intro">
            ...
            <div id="index-shop">
                <ul>
                    <li><a href="#" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow" rel="external nofollow">
                        <div class="shop-list">
                            <div class="shop-list-pic"><img width="100%" height="100%" src="/test/culture3.0/Public/Home/image/shop/products/banya1.jpg"/></div>
