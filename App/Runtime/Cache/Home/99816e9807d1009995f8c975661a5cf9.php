...
<meta charset="UTF-8">
<title>区县名录</title>
<link href="/test/legacy/Public/Home/css/director.css" rel="stylesheet">
<div class="container">
    <br>
    <div class="row">
        <div class="col-lg-12">
            <h2 class="page-header">区县名录/<?php echo ($cName); ?></h2>
        </div>
    </div>
    <section class="countryList">
        <div class="row list-box">
            <?php if(is_array($countryList)): foreach($countryList as $key=>$cl): ?><div class="col-xs-12 col-sm-5 col-md-5  col-lg-4 list-pic">
                    <img class="intro-pic" src="/test/legacy/Public/Home/image/minglu/<?php echo ($cl["number"]); ?>.jpg">
                </div>
                <div class="col-xs-12 col-sm-12 col-md-8 col-lg-8 list-intro">
                    <div class="intro-box">
                        <h3 class="page-header"><?php echo ($cl["name"]); ?> | 简介</h3>
                        <p>&nbsp;&nbsp;&nbsp;<?php echo (msubstr($cl["introduce"],0,400,'utf-8')); ?></p>
                    </div>
